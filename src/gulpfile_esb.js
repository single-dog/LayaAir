...
var packsDef = [
    {
        ...
        'out': buildDir + '/libs/laya.core.js'
    },
    {
        'libName': "d3",
        'input': [
    ...
    },
    {
        ...
        'out': buildDir + '/libs/laya.gltf.js'
    },
    {
        ...
        'out': buildDir + '/libs/laya.cannonPhysics.js'
    },
    {
        ...
        'out':buildDir + '/libs/laya.bullet.js'
    },
    {
        'libName': 'device',
        'input': [
        ...
        'out': buildDir + '/libs/laya.device.js'
    },
    {
        'libName': 'tiledmap',
        'input': [
        ...
        'out': buildDir + '/libs/laya.tiledmap.js'
    },
    {
        'libName': 'html',
        'input': [
        ...
        'out': buildDir + '/libs/laya.html.js'
    },
    {
        'libName': 'particle',
        'input': [
        ...
        'out': buildDir + '/libs/laya.particle.js'
    },

    {
        ...
        'out': buildDir + '/libs/laya.physics.js'
    },
    {
        'libName': 'ui',
        'input': [
    ...
    },//debugtool
    {
        ...
        'out': buildDir + '/libs/laya.debugtool.js'
    },
    {
        ...
        'out':buildDir + '/libs/laya.performancetool.js'
    }
];
...
gulp.task('ConcatBox2dPhysics', function (cb) {
    pump([
        gulp.src([
            ...
            buildDir + '/libs/laya.physics.js']),
        concat('laya.physics.js'),//合并后的文件名
        gulp.dest(buildDir + '/libs/'),
    ], cb);
});
...
gulp.task('ConcatCannonPhysics', function (cb) {
    pump([
        gulp.src([
            ...
            buildDir + '/libs/laya.cannonPhysics.js']),
...
gulp.task('ConcatBulletPhysics', function (cb) {
    pump([
        ...
        fs.unlinkSync(buildDir + '/libs/laya.bullet.js');
        cb();
    });
});
...
gulp.task('CopyJSFileToTSCompatible', () => {
    return gulp.src([
        './layaAir/jsLibs/laya.physics3D.wasm.wasm',buildDir + '/libs/**/*.js'])
...
gulp.task('CopyJSFileToAS', () => {
    return gulp.src([
        './layaAir/jsLibs/laya.physics3D.wasm.wasm',buildDir + '/libs/**/*.js', '!../build/js/declare/*ts'])
...
const esbuild = require("./publishTool/rollup-plugin-esbuild");
...
gulp.task("compressJs", function () {
    gulp.src("../build/as/jslibs/laya.physics3D.js")
        ...
        .pipe(gulp.dest(buildDir + "/libs/min"))
